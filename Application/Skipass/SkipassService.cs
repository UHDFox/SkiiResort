...
internal class SkipassService : ISkipassService
{
   ...
   {
       return mapper.Map<GetSkipassModel>(await context.Skipasses.FindAsync(skipassId)) ?? throw new NotFoundException("Skipass not found");
   }
   ...
   {
       //var _ = context.Skipasses.FindAsync((updatedSkipass.Id)) ?? 
